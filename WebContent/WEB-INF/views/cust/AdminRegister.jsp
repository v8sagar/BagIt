    ...
    <form:form method="POST" modelAttribute="customersDetails" class="form-horizontal">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:input type="text" placeholder="LastName" path="lastName" id="lastName" class="form-control input-sm"/>
                    <div class="has-error">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:input type="text" placeholder="Adrres" path="addres" id="addres" class="form-control input-sm"/>
                    <div class="has-error">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:input type="text" placeholder="Email Id"  path="emailId" id=" emailId" class="form-control input-sm"/>
                    <div class="has-error">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:input type="text" placeholder="Mobile no" path="mobileNo" id="mobileNo" class="form-control input-sm"/>
                    <div class="has-error">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:input type="text" placeholder="month-day-year" path="registrationDate" id="registrationDate" class="form-control input-sm"/>
                    <div class="has-error">
